import allure
import pytest
from pages.questions_page import PageQuestions
from conftest import driver

class TestPageQuestion:

    @allure.title('Проверка соответсвия вопрос - ответ')
    ...
    def test_answer_to_question(self, driver, question, answer, id):
        page_question = PageQuestions(driver)
        page_question.go_to_site()
        assert question == page_question.find_question(id)
        assert answer == page_question.find_answer(id)
